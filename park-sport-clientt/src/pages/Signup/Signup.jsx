            ...
            <div className="lg:flex lg:gap-x-4 justify-center items-center mx-4">
                ...
                <div className="w-full bg-white rounded-md lg:max-w-xl">
                    ...
                    <form className="mt-6">
                        ...
                        <div className="mt-6">
                            <button className="w-full px-4 py-2 text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:bg-gray-600">
                                Sign up
                            </button>
                        </div>
                    </form>
                    ...
                    <div className="flex mt-4 gap-x-2">
                        <button
                            type="button"
                            className="flex items-center justify-center w-full p-2 border border-green-500 focus:ring-2 focus:ring-offset-1 focus:ring-green-600"
                        >
                            <svg
                        ...
                        <button className="flex items-center justify-center w-full p-2 border border-green-500 focus:ring-2 focus:ring-offset-1 focus:ring-green-600">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 32 32"
                                className="w-5 h-5 fill-current"
